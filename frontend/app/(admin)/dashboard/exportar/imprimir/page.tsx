...
export default async function ImprimirPage({ searchParams }: PrintPageProps) {
  ...
  return (
    <html lang="es">
      ...
      <body>
        <h1>{titulo}</h1>
        <p className="meta">Mantis · Generado el {fecha} · {filas.length} registros</p>
        ...
        <p className="footer">Mantis · Sistema de Gestión de Incidentes</p>
      </body>
    </html>
  )
}
