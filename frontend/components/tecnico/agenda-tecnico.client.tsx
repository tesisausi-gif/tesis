...
const DAY_PICKER_CLASSES = {
  ...
  button_previous: 'absolute left-0 h-7 w-7 bg-transparent p-0 opacity-40 hover:opacity-100 active:opacity-100 flex items-center justify-center rounded-lg hover:bg-slate-100 active:bg-slate-100 transition-colors',
  button_next:     'absolute right-0 h-7 w-7 bg-transparent p-0 opacity-40 hover:opacity-100 active:opacity-100 flex items-center justify-center rounded-lg hover:bg-slate-100 active:bg-slate-100 transition-colors',
