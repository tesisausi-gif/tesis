...
import { TecnicoInicioContent } from '@/components/tecnico/tecnico-inicio-content.client'
...
export default async function TecnicoDashboard() {
  ...
  return (
    <TecnicoInicioContent
      ...
      cntEnProceso={estadosPorIncidente.filter(e => e === 'en_proceso').length}
      cntFinalizado={estadosPorIncidente.filter(e => e === 'finalizado' || e === 'resuelto').length}
