...
function TabR5() {
  ...
  const cols = ['Tipo', 'Cobrado a cliente', 'Pagado al técnico', 'Comisión Mantis', 'Margen %']
      ...
      <Card className="border-blue-100 bg-blue-50/40">
        <CardContent className="pt-4 pb-3">
          <p className="text-xs text-blue-700">
            <strong>Nota:</strong> Comisión Mantis = lo cobrado al cliente menos lo pagado al técnico (materiales + mano de obra).
      ...
      {resultado && (
        <>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            <KpiCard label="Comisión Mantis" valor={fmt$(resultado.comisionTotal)} sub="margen neto" />
  ...
  return (
    <div className="space-y-4">
      <Card className="border-blue-100 bg-blue-50/40">
        <CardContent className="pt-4 pb-3">
          <p className="text-xs text-blue-700">
            <strong>Cobrado a clientes</strong>: montos registrados en cobros_clientes (lo que el cliente pagó a Mantis por cada incidente). ·{' '}
