...
-- Comentarios
COMMENT ON POLICY "admin_gestor_all_clientes" ON public.clientes IS
  'Permite a admin y gestor acceso completo a todos los clientes';
COMMENT ON POLICY "clientes_view_own" ON public.clientes IS
  'Permite a clientes ver solo sus propios datos';
