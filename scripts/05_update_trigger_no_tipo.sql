-- ============================================
-- ACTUALIZAR TRIGGER PARA NO USAR tipo_cliente
-- ============================================
...
COMMENT ON FUNCTION public.handle_new_user() IS 'Trigger actualizado que crea registros en usuarios, clientes y tecnicos sin usar tipo_cliente';
